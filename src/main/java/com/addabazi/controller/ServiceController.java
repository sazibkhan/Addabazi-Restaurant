...
import com.spring.upload.ServiceUpload;
import com.spring.upload.ServiceUploadImpl;
...
public class ServiceController implements Serializable{
	...
	public void saveService(){
		FacesContext mass=FacesContext.getCurrentInstance();
		try{	
			ServiceUpload upload=new ServiceUploadImpl();
			String fileName=uploadFile.getFileName();
			upload.upload("Service", fileName, uploadFile);
